    ...
    <div className='about'>
      <div>
        <h6>
          ...
          However, I craved more knowledge and challenges.
        </h6>
        <h6>
        ...
        <h6>
          Beyond my professional pursuits, I indulge my passion for <span className='emphasize'>sports</span>, <span className='emphasize'>video games</span>,
